...
import Control.Concurrent.STM (STM, TChan, TVar, atomically, modifyTVar', newTChan, newTVar, newTVarIO, readTChan, readTVar, writeTChan, writeTVar)
import Control.Exception (finally, mask)
import Control.Monad (forever, join, void, when)
import Data.Map (Map)
import qualified Data.Map as Map
import Network (PortID (PortNumber), accept, listenOn, withSocketsDo)
import System.IO (BufferMode (LineBuffering), Handle, hClose, hGetLine, hPutStrLn, hSetBuffering, hSetNewlineMode, universalNewlineMode)

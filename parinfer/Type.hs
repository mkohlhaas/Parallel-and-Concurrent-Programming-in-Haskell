...
import MyList (minus)
import Shows (Shows, showsParenIf, showsStar, showsString)
...
showsMono d (TVar xx) = showsString xx
...
instance Show PolyType where
  showsPrec d (All xs t) = showsString "All " . showsString (unwords xs) . showsString ". " . showsMono 0 t
